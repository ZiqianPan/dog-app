...
export default function Home() {
  ...
  return (
    <>
      {!dogs ? (
        <h1 className="flex items-center justify-center text-center px-5 text-3xl h-screen font-bold uppercase text-white">
          Loading...
        </h1>
      ) : (
        <>
            ...
            <div className="text-center">
              ...
              >
                <input
                  ...
                  className="px-4 rounded shadow w-full bg-slate-400 placeholder-white text-white"
                  value={text}
                ...
                dogs.map((dog) => (
                  ...
                  >
                    <article>
                      ...
                      />
                      <h3 className="text-white text-lg front-bold mt-4">
                        {dog.name}
                      </h3>
